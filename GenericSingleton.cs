...
///     from this class. Also override <code>InternalOnDestroy()</code> method to add
///     custom behavior when object will be destroyed.
/// </summary>
...
public abstract class GenericSingleton<T> : MonoBehaviour where T : GenericSingleton<T>
{
    ...
    protected virtual void Awake()
    {
        ...
        {
            Debug.LogError($"[Custom Singleton] Another instance of {GetType()} already exist! Destroying self...");
            Destroy(this);
            return;
        }
        _instance.Init();
    ...
    // Logic for what will happen on scene change
